...
#define LV_USE_STDLIB_SPRINTF   LV_STDLIB_BUILTIN
    ...
    /*Allocate the memory as a static array. Use LV_ATTRIBUTE_LARGE_RAM_ARRAY compiler option to set location*/
    #define LV_MEM_ADR 0
...
/*Attribute to mark benchmark assets*/
#define LV_ATTRIBUTE_IMAGE_IMG_COGWHEEL_ARGB        LV_ATTRIBUTE_LARGE_CONST
#define LV_ATTRIBUTE_IMAGE_IMG_COGWHEEL_RGB         LV_ATTRIBUTE_LARGE_CONST
#define LV_ATTRIBUTE_IMAGE_IMG_DEMO_WIDGETS_NEEDLE  LV_ATTRIBUTE_LARGE_CONST
/*Compiler prefix for a big array declaration in RAM*/
#define LV_ATTRIBUTE_LARGE_RAM_ARRAY __attribute__((section(".bss.at_sram1")))
