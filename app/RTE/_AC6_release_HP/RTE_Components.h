 ...
 *
 * Project: 'app.AC6_release+HP' 
 * Target:  'AC6_release+HP' 
 */
...
/* AlifSemiconductor::BSP:External peripherals:ILI9806E LCD panel@1.1.0 */
...
/* AlifSemiconductor::Device:SOC Peripherals:MIPI DSI@1.1.0 */
